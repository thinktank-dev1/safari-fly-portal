...
<div class="col-md-12 d-flex justify-content-center">    
    <div class="login-card d-xl-none d-lg-none d-md-none d-sm-flex">
        <div class="col header d-flex justify-content-center"><p class="login-heading">REGISTER</p></div>
        <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                    ...
                    <div class="d-flex justify-content-center input-group mb-3" id="show_hide_password">
                        <input id="password-confirm" type="password" class="form-control password-control" name="password_confirmation" placeholder="Confirm Password*" autocomplete="new-password" aria-describedby="button-addon1">
                        <div class="input-group-append">
                            <a href="" class="input-group-text" id="basic-addon1"><i class="bi bi-eye-fill"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-12 d-flex justify-content-center mb-3">
                    @if (Route::has('register'))
                        <p class="register-text">
                            Not a member yet? 
                            <a class="btn btn-primary-link" href="{{ route('login') }}">
                                {{ __('Sign in') }}
                            </a>
                        <p>
                    @endif
